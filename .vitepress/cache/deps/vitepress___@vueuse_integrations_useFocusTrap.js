...
// node_modules/.pnpm/@vueuse+integrations@12.8.2_axios@1.9.0_focus-trap@7.6.4_typescript@5.8.3/node_modules/@vueuse/integrations/useFocusTrap.mjs
var import_vue = __toESM(require_vue(), 1)
function useFocusTrap(target, options = {}) {
  let trap
  const { immediate, ...focusTrapOptions } = options
  const hasFocus = (0, import_vue.shallowRef)(false)
  const isPaused = (0, import_vue.shallowRef)(false)
  ...
  const targets = (0, import_vue.computed)(() => {
    const _targets = (0, import_vue.toValue)(target)
    return toArray(_targets)
      .map((el) => {
        const _el = (0, import_vue.toValue)(el)

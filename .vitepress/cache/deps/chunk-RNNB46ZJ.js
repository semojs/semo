import { require_vue } from './chunk-RSMQGDTC.js'
import { __toESM } from './chunk-V4OQ3NZ2.js'
...
function computedWithControl(source, fn) {
  ...
  let track
  let trigger
  const dirty = (0, import_vue.shallowRef)(true)
  const update = () => {
    dirty.value = true
    trigger()
  }
  ;(0, import_vue.watch)(source, update, { flush: 'sync' })
  const get2 = typeof fn === 'function' ? fn : fn.get
  const set2 = typeof fn === 'function' ? void 0 : fn.set
  const result = (0, import_vue.customRef)((_track, _trigger) => {
    track = _track
    trigger = _trigger
    return {
      get() {
...
function tryOnScopeDispose(fn) {
  if ((0, import_vue.getCurrentScope)()) {
    ;(0, import_vue.onScopeDispose)(fn)
    return true
  }
  return false
}
...
var injectLocal = (...args) => {
  ...
  const key = args[0]
  const instance =
    (_a = (0, import_vue.getCurrentInstance)()) == null ? void 0 : _a.proxy
  if (instance == null && !(0, import_vue.hasInjectionContext)())
  ...
  return (0, import_vue.inject)(...args)
}
var provideLocal = (key, value) => {
  ...
  ;(0, import_vue.provide)(key, value)
}
...
function createRef(value, deep) {
  if (deep === true) {
    return (0, import_vue.ref)(value)
  } else {
    return (0, import_vue.shallowRef)(value)
  }
}
function createSharedComposable(composable) {
  ...
  return (...args) => {
    subscribers += 1
    if (!scope) {
      scope = (0, import_vue.effectScope)(true)
...
function extendRef(ref3, extend, { enumerable = false, unwrap = true } = {}) {
  for (const [key, value] of Object.entries(extend)) {
    ...
    if ((0, import_vue.isRef)(value) && unwrap) {
...
function get(obj, key) {
  if (key == null) return (0, import_vue.unref)(obj)
  return (0, import_vue.unref)(obj)[key]
}
function isDefined(v) {
  return (0, import_vue.unref)(v) != null
}
...
function toReactive(objectRef) {
  if (!(0, import_vue.isRef)(objectRef))
    return (0, import_vue.reactive)(objectRef)
  const proxy = new Proxy(
    {},
    {
      get(_, p, receiver) {
        return (0, import_vue.unref)(Reflect.get(objectRef.value, p, receiver))
      },
      set(_, p, value) {
        if (
          (0, import_vue.isRef)(objectRef.value[p]) &&
          !(0, import_vue.isRef)(value)
        )
  ...
  return (0, import_vue.reactive)(proxy)
}
function reactiveComputed(fn) {
  return toReactive((0, import_vue.computed)(fn))
}
function reactiveOmit(obj, ...keys2) {
  ...
  return reactiveComputed(() =>
    typeof predicate === 'function'
      ? Object.fromEntries(
          Object.entries((0, import_vue.toRefs)(obj)).filter(
            ([k, v]) => !predicate((0, import_vue.toValue)(v), k)
          )
        )
      : Object.fromEntries(
          Object.entries((0, import_vue.toRefs)(obj)).filter(
...
function debounceFilter(ms, options = {}) {
  ...
  const filter = (invoke2) => {
    const duration = (0, import_vue.toValue)(ms)
    const maxDuration = (0, import_vue.toValue)(options.maxWait)
...
function throttleFilter(...args) {
  ...
  let leading
  let rejectOnCancel
  if (!(0, import_vue.isRef)(args[0]) && typeof args[0] === 'object')
    ({
      delay: ms,
      trailing = true,
      leading = true,
...
function pausableFilter(extendFilter = bypassFilter, options = {}) {
  ...
  return {
    isActive: (0, import_vue.readonly)(isActive),
    pause,
    resume,
    eventFilter,
  }
...
function getLifeCycleTarget(target) {
  return target || (0, import_vue.getCurrentInstance)()
}
function toArray(value) {
  return Array.isArray(value) ? value : [value]
}
function toRef(...args) {
  if (args.length !== 1) return (0, import_vue.toRef)(...args)
  const r = args[0]
  return typeof r === 'function'
    ? (0, import_vue.readonly)(
        (0, import_vue.customRef)(() => ({ get: r, set: noop }))
      )
    : (0, import_vue.ref)(r)
}
...
function reactivePick(obj, ...keys2) {
  ...
  return reactiveComputed(() =>
    typeof predicate === 'function'
      ? Object.fromEntries(
          Object.entries((0, import_vue.toRefs)(obj)).filter(([k, v]) =>
            predicate((0, import_vue.toValue)(v), k)
          )
        )
...
function refAutoReset(defaultValue, afterMs = 1e4) {
  return (0, import_vue.customRef)((track, trigger) => {
    let value = (0, import_vue.toValue)(defaultValue)
    let timer
    const resetAfter = () =>
      setTimeout(
        () => {
          value = (0, import_vue.toValue)(defaultValue)
          trigger()
        },
        (0, import_vue.toValue)(afterMs)
      )
    tryOnScopeDispose(() => {
      clearTimeout(timer)
    })
...
function refDebounced(value, ms = 200, options = {}) {
  const debounced = (0, import_vue.ref)(value.value)
  ...
  ;(0, import_vue.watch)(value, () => updater())
  return debounced
}
...
function refThrottled(value, delay = 200, trailing = true, leading = true) {
  ...
  const throttled = (0, import_vue.ref)(value.value)
...
function refWithControl(initial, options = {}) {
  ...
  let track
  let trigger
  const ref3 = (0, import_vue.customRef)((_track, _trigger) => {
    track = _track
    trigger = _trigger
    return {
      get() {
  ...
  for (const key in objectRef.value) {
    result[key] = (0, import_vue.customRef)(() => ({
      ...
      set(v) {
        var _a
        const replaceRef =
          (_a = (0, import_vue.toValue)(options.replaceRef)) != null ? _a : true
        if (replaceRef) {
...
var toValue = import_vue.toValue
var resolveUnref = import_vue.toValue
function tryOnBeforeMount(fn, sync = true, target) {
  const instance = getLifeCycleTarget(target)
  if (instance) (0, import_vue.onBeforeMount)(fn, target)
  else if (sync) fn()
  else (0, import_vue.nextTick)(fn)
}
function tryOnBeforeUnmount(fn, target) {
  const instance = getLifeCycleTarget(target)
  if (instance) (0, import_vue.onBeforeUnmount)(fn, target)
}
function tryOnMounted(fn, sync = true, target) {
  const instance = getLifeCycleTarget()
  if (instance) (0, import_vue.onMounted)(fn, target)
  else if (sync) fn()
  else (0, import_vue.nextTick)(fn)
}
function tryOnUnmounted(fn, target) {
  const instance = getLifeCycleTarget(target)
  if (instance) (0, import_vue.onUnmounted)(fn, target)
}
function createUntil(r, isNot = false) {
  ...
  function toContains(value, options) {
    return toMatch((v) => {
      ...
      return (
        array.includes(value) || array.includes((0, import_vue.toValue)(value))
      )
    }, options)
  }
  ...
  if (Array.isArray((0, import_vue.toValue)(r))) {
    const instance = {
      toMatch,
      toContains,
      changed,
...
function useArrayDifference(...args) {
  ...
  const diff1 = (0, import_vue.computed)(() =>
    (0, import_vue.toValue)(list).filter(
      (x) =>
        (0, import_vue.toValue)(values).findIndex((y) => compareFn(x, y)) === -1
    )
  )
  if (symmetric) {
    const diff2 = (0, import_vue.computed)(() =>
      (0, import_vue.toValue)(values).filter(
        (x) =>
          (0, import_vue.toValue)(list).findIndex((y) => compareFn(x, y)) === -1
      )
    )
    return (0, import_vue.computed)(() =>
      symmetric
        ? [...(0, import_vue.toValue)(diff1), ...(0, import_vue.toValue)(diff2)]
        : (0, import_vue.toValue)(diff1)
    )
  } else {
    return diff1
  }
...
function useArrayEvery(list, fn) {
  return (0, import_vue.computed)(() =>
    (0, import_vue.toValue)(list).every((element, index, array) =>
      fn((0, import_vue.toValue)(element), index, array)
    )
  )
}
function useArrayFilter(list, fn) {
  return (0, import_vue.computed)(() =>
    (0, import_vue.toValue)(list)
      .map((i) => (0, import_vue.toValue)(i))
      .filter(fn)
  )
}
function useArrayFind(list, fn) {
  return (0, import_vue.computed)(() =>
    (0, import_vue.toValue)(
      (0, import_vue.toValue)(list).find((element, index, array) =>
        fn((0, import_vue.toValue)(element), index, array)
      )
    )
  )
...
function useArrayFindIndex(list, fn) {
  return (0, import_vue.computed)(() =>
    (0, import_vue.toValue)(list).findIndex((element, index, array) =>
      fn((0, import_vue.toValue)(element), index, array)
    )
  )
}
  ...
  return (0, import_vue.computed)(() =>
    (0, import_vue.toValue)(
      !Array.prototype.findLast
        ? findLast((0, import_vue.toValue)(list), (element, index, array) =>
            fn((0, import_vue.toValue)(element), index, array)
          )
        : (0, import_vue.toValue)(list).findLast((element, index, array) =>
            fn((0, import_vue.toValue)(element), index, array)
          )
    )
  )
...
function useArrayIncludes(...args) {
  ...
  if (typeof comparator === 'string') {
    ...
    comparator = (element, value2) =>
      element[key] === (0, import_vue.toValue)(value2)
  }
  comparator =
    comparator != null
      ? comparator
      : (element, value2) => element === (0, import_vue.toValue)(value2)
  return (0, import_vue.computed)(() =>
    (0, import_vue.toValue)(list)
      .slice(formIndex)
      .some((element, index, array) =>
        comparator(
          (0, import_vue.toValue)(element),
          (0, import_vue.toValue)(value),
          index,
          (0, import_vue.toValue)(array)
        )
      )
  )
}
function useArrayJoin(list, separator) {
  return (0, import_vue.computed)(() =>
    (0, import_vue.toValue)(list)
      .map((i) => (0, import_vue.toValue)(i))
      .join((0, import_vue.toValue)(separator))
  )
}
...
function useArrayReduce(list, reducer, ...args) {
  const reduceCallback = (sum, value, index) =>
    reducer((0, import_vue.toValue)(sum), (0, import_vue.toValue)(value), index)
  return (0, import_vue.computed)(() => {
    const resolved = (0, import_vue.toValue)(list)
    return args.length
      ? resolved.reduce(
          reduceCallback,
          typeof args[0] === 'function'
            ? (0, import_vue.toValue)(args[0]())
            : (0, import_vue.toValue)(args[0])
        )
...
function useArraySome(list, fn) {
  return (0, import_vue.computed)(() =>
    (0, import_vue.toValue)(list).some((element, index, array) =>
      fn((0, import_vue.toValue)(element), index, array)
    )
  )
}
...
function useArrayUnique(list, compareFn) {
  return (0, import_vue.computed)(() => {
    const resolvedList = (0, import_vue.toValue)(list).map((element) =>
      (0, import_vue.toValue)(element)
    )
    return compareFn
...
function useCounter(initialValue = 0, options = {}) {
  let _initialValue = (0, import_vue.unref)(initialValue)
  const count = (0, import_vue.shallowRef)(initialValue)
...
function formatDate(date, formatStr, options = {}) {
  ...
  const matches = {
    ...
    MMM: () =>
      date.toLocaleDateString((0, import_vue.toValue)(options.locales), {
        month: 'short',
      }),
    MMMM: () =>
      date.toLocaleDateString((0, import_vue.toValue)(options.locales), {
...
function useDateFormat(date, formatStr = 'HH:mm:ss', options = {}) {
  return (0, import_vue.computed)(() =>
    formatDate(
      normalizeDate((0, import_vue.toValue)(date)),
      (0, import_vue.toValue)(formatStr),
      options
    )
  )
}
function useIntervalFn(cb, interval = 1e3, options = {}) {
  ...
  let timer = null
  const isActive = (0, import_vue.shallowRef)(false)
  function clean() {
    if (timer) {
      clearInterval(timer)
      timer = null
  ...
  function resume() {
    const intervalValue = (0, import_vue.toValue)(interval)
  ...
  if ((0, import_vue.isRef)(interval) || typeof interval === 'function') {
    const stopWatch = (0, import_vue.watch)(interval, () => {
...
function useInterval(interval = 1e3, options = {}) {
  ...
  const counter = (0, import_vue.shallowRef)(0)
...
function useLastChanged(source, options = {}) {
  var _a
  const ms = (0, import_vue.shallowRef)(
    (_a = options.initialValue) != null ? _a : null
  )
  ;(0, import_vue.watch)(source, () => (ms.value = timestamp()), options)
  return ms
}
function useTimeoutFn(cb, interval, options = {}) {
  const { immediate = true, immediateCallback = false } = options
  const isPending = (0, import_vue.shallowRef)(false)
  let timer = null
  function clear() {
    if (timer) {
      clearTimeout(timer)
...
function useTimeout(interval = 1e3, options = {}) {
  ...
  const ready = (0, import_vue.computed)(() => !controls.isPending.value)
  if (exposeControls) {
    return {
      ready,
      ...controls,
...
function useToNumber(value, options = {}) {
  ...
  return (0, import_vue.computed)(() => {
    let resolved = (0, import_vue.toValue)(value)
...
function useToString(value) {
  return (0, import_vue.computed)(() => `${(0, import_vue.toValue)(value)}`)
}
function useToggle(initialValue = false, options = {}) {
  const { truthyValue = true, falsyValue = false } = options
  const valueIsRef = (0, import_vue.isRef)(initialValue)
  const _value = (0, import_vue.shallowRef)(initialValue)
  function toggle(value) {
    if (arguments.length) {
      _value.value = value
      return _value.value
    } else {
      const truthy = (0, import_vue.toValue)(truthyValue)
      _value.value =
        _value.value === truthy ? (0, import_vue.toValue)(falsyValue) : truthy
      return _value.value
    }
  }
...
function watchAtMost(source, cb, options) {
  ...
  const current = (0, import_vue.shallowRef)(0)
  const stop = watchWithFilter(
    source,
    (...args) => {
      current.value += 1
      if (current.value >= (0, import_vue.toValue)(count))
        (0, import_vue.nextTick)(() => stop())
      cb(...args)
    },
    watchOptions
  )
...
function watchDeep(source, cb, options) {
  return (0, import_vue.watch)(source, cb, {
    ...options,
    deep: true,
  })
}
function watchIgnorable(source, cb, options = {}) {
  ...
  if (watchOptions.flush === 'sync') {
    const ignore = (0, import_vue.shallowRef)(false)
    ...
    const disposables = []
    const ignoreCounter = (0, import_vue.shallowRef)(0)
    const syncCounter = (0, import_vue.shallowRef)(0)
    ignorePrevAsyncUpdates = () => {
...
function getWatchSources(sources) {
  if ((0, import_vue.isReactive)(sources)) return sources
  if (Array.isArray(sources))
    return sources.map((item) => (0, import_vue.toValue)(item))
  return (0, import_vue.toValue)(sources)
}
...
function computedAsync(evaluationCallback, initialState, optionsOrRef) {
  let options
  if ((0, import_vue2.isRef)(optionsOrRef)) {
    options = {
  ...
  const started = (0, import_vue2.shallowRef)(!lazy)
  const current = shallow
    ? (0, import_vue2.shallowRef)(initialState)
    : (0, import_vue2.ref)(initialState)
  let counter = 0
  ;(0, import_vue2.watchEffect)(async (onInvalidate) => {
...
function computedInject(key, options, defaultSource, treatDefaultAsFactory) {
  let source = (0, import_vue2.inject)(key)
  if (defaultSource) source = (0, import_vue2.inject)(key, defaultSource)
  if (treatDefaultAsFactory)
    source = (0, import_vue2.inject)(key, defaultSource, treatDefaultAsFactory)
  if (typeof options === 'function') {
    return (0, import_vue2.computed)((ctx) => options(source, ctx))
  } else {
    return (0, import_vue2.computed)({
...
function createReusableTemplate(options = {}) {
  ...
  const render = (0, import_vue2.shallowRef)()
  const define = (0, import_vue2.defineComponent)({
    setup(_, { slots }) {
      return () => {
  ...
  const reuse = (0, import_vue2.defineComponent)({
    inheritAttrs,
    props: options.props,
...
function createTemplatePromise(options = {}) {
  let index = 0
  const instances = (0, import_vue2.ref)([])
  function create(...args) {
    const props = (0, import_vue2.shallowReactive)({
      key: index++,
      args,
      promise: void 0,
      resolve: () => {},
  ...
  const component = (0, import_vue2.defineComponent)((_, { slots }) => {
    const renderList = () =>
...
function createUnrefFn(fn) {
  return function (...args) {
    return fn.apply(
      this,
      args.map((i) => (0, import_vue2.toValue)(i))
    )
  }
}
...
function useEventListener(...args) {
  ...
  const firstParamTargets = (0, import_vue2.computed)(() => {
    const test = toArray((0, import_vue2.toValue)(args[0])).filter(
      (e) => e != null
    )
  ...
  const stopWatch = watchImmediate(
    () => {
      ...
      return [
        ...
        toArray(
          (0, import_vue2.toValue)(firstParamTargets.value ? args[1] : args[0])
        ),
        toArray(
          (0, import_vue2.unref)(firstParamTargets.value ? args[2] : args[1])
        ),
        // @ts-expect-error - TypeScript gets the correct types, but somehow still complains
        (0, import_vue2.toValue)(firstParamTargets.value ? args[3] : args[2]),
      ]
    },
...
function onClickOutside(target, handler, options = {}) {
  ...
  const shouldIgnore = (event) => {
    return (0, import_vue2.toValue)(ignore).some((target2) => {
  ...
  function hasMultipleRoots(target2) {
    const vm = (0, import_vue2.toValue)(target2)
...
function useMounted() {
  const isMounted = (0, import_vue2.shallowRef)(false)
...
function useMutationObserver(target, callback, options = {}) {
  ...
  const targets = (0, import_vue2.computed)(() => {
    const value = (0, import_vue2.toValue)(target)
    const items = toArray(value).map(unrefElement).filter(notNullish)
    return new Set(items)
  })
  const stopWatch = (0, import_vue2.watch)(
    () => targets.value,
    (targets2) => {
      cleanup()
...
function onElementRemoval(target, callback, options = {}) {
  ...
  const stopWatch = (0, import_vue2.watchEffect)(
    () => {
      const el = unrefElement(target)
      if (el) {
...
function onKeyStroke(...args) {
  ...
  const listener = (e) => {
    if (e.repeat && (0, import_vue2.toValue)(dedupe)) return
...
function onLongPress(target, handler, options) {
  var _a, _b
  const elementRef = (0, import_vue2.computed)(() => unrefElement(target))
  let timeout
  let posStart
  let startTimestamp
...
function templateRef(key, initialValue = null) {
  const instance = (0, import_vue2.getCurrentInstance)()
  let _trigger = () => {}
  const element = (0, import_vue2.customRef)((track, trigger) => {
    _trigger = trigger
    return {
      get() {
        var _a, _b
  ...
  ;(0, import_vue2.onUpdated)(_trigger)
  return element
}
function useActiveElement(options = {}) {
  ...
  const activeElement = (0, import_vue2.shallowRef)()
  const trigger = () => {
...
function useRafFn(fn, options = {}) {
  ...
  const isActive = (0, import_vue2.shallowRef)(false)
  const intervalLimit = (0, import_vue2.computed)(() => {
    return fpsLimit ? 1e3 / (0, import_vue2.toValue)(fpsLimit) : null
  })
  ...
  tryOnScopeDispose(pause)
  return {
    isActive: (0, import_vue2.readonly)(isActive),
    pause,
    resume,
  }
}
function useAnimate(target, keyframes, options) {
  ...
  const animate = (0, import_vue2.shallowRef)(void 0)
  const store = (0, import_vue2.shallowReactive)({
    startTime: null,
    currentTime: null,
    timeline: null,
  ...
  const pending = (0, import_vue2.computed)(() => store.pending)
  const playState = (0, import_vue2.computed)(() => store.playState)
  const replaceState = (0, import_vue2.computed)(() => store.replaceState)
  const startTime = (0, import_vue2.computed)({
    get() {
  ...
  const currentTime = (0, import_vue2.computed)({
    get() {
  ...
  const timeline = (0, import_vue2.computed)({
    get() {
  ...
  const playbackRate = (0, import_vue2.computed)({
    get() {
  ...
  function update(init) {
    ...
    if (!animate.value)
      animate.value = el.animate(
        (0, import_vue2.toValue)(keyframes),
        animateOptions
      )
...
function useAsyncQueue(tasks, options) {
  ...
  const result = (0, import_vue2.reactive)(initialResult)
  const activeIndex = (0, import_vue2.shallowRef)(-1)
...
function useAsyncState(promise, initialState, options) {
  ...
  const state = shallow
    ? (0, import_vue2.shallowRef)(initialState)
    : (0, import_vue2.ref)(initialState)
  const isReady = (0, import_vue2.shallowRef)(false)
  const isLoading = (0, import_vue2.shallowRef)(false)
  const error = (0, import_vue2.shallowRef)(void 0)
...
function useBase64(target, options) {
  const base64 = (0, import_vue2.shallowRef)('')
  const promise = (0, import_vue2.shallowRef)()
  function execute() {
    if (!isClient) return
    promise.value = new Promise((resolve, reject) => {
      try {
        const _target = (0, import_vue2.toValue)(target)
        if (_target == null) {
          resolve('')
  ...
  if ((0, import_vue2.isRef)(target) || typeof target === 'function')
    (0, import_vue2.watch)(target, execute, { immediate: true })
  else execute()
  return {
    base64,
    promise,
...
function useBattery(options = {}) {
  ...
  const charging = (0, import_vue2.shallowRef)(false)
  const chargingTime = (0, import_vue2.shallowRef)(0)
  const dischargingTime = (0, import_vue2.shallowRef)(0)
  const level = (0, import_vue2.shallowRef)(1)
  let battery
...
function useBluetooth(options) {
  ...
  const device = (0, import_vue2.shallowRef)()
  const error = (0, import_vue2.shallowRef)(null)
  ;(0, import_vue2.watch)(device, () => {
  ...
  const server = (0, import_vue2.shallowRef)()
  const isConnected = (0, import_vue2.shallowRef)(false)
  function reset() {
  ...
  return {
    isSupported,
    isConnected: (0, import_vue2.readonly)(isConnected),
    // Device:
    device,
    requestDevice,
    // Server:
...
function useSSRWidth() {
  const ssrWidth = (0, import_vue2.hasInjectionContext)()
...
function useMediaQuery(query, options = {}) {
  ...
  const ssrSupport = (0, import_vue2.shallowRef)(typeof ssrWidth === 'number')
  const mediaQuery = (0, import_vue2.shallowRef)()
  const matches = (0, import_vue2.shallowRef)(false)
  const handler = (event) => {
  ...
  ;(0, import_vue2.watchEffect)(() => {
    if (ssrSupport.value) {
      ...
      const queryStrings = (0, import_vue2.toValue)(query).split(',')
    ...
    if (!isSupported.value) return
    mediaQuery.value = window2.matchMedia((0, import_vue2.toValue)(query))
    matches.value = mediaQuery.value.matches
  })
  useEventListener(mediaQuery, 'change', handler, { passive: true })
  return (0, import_vue2.computed)(() => matches.value)
}
...
function useBreakpoints(breakpoints, options = {}) {
  function getValue2(k, delta) {
    let v = (0, import_vue2.toValue)(breakpoints[(0, import_vue2.toValue)(k)])
  ...
  const mounted = ssrSupport
    ? (0, import_vue2.shallowRef)(false)
    : { value: true }
  if (ssrSupport) {
...
function useBroadcastChannel(options) {
  ...
  const isClosed = (0, import_vue2.shallowRef)(false)
  const channel = (0, import_vue2.ref)()
...
function useBrowserLocation(options = {}) {
  ...
  const refs = Object.fromEntries(
    WRITABLE_PROPERTIES.map((key) => [key, (0, import_vue2.ref)()])
  )
  for (const [key, ref3] of objectEntries(refs)) {
    ;(0, import_vue2.watch)(ref3, (value) => {
      if (
  ...
  const state = (0, import_vue2.ref)(buildState('load'))
  if (window2) {
    const listenerOptions = { passive: true }
    useEventListener(
      window2,
...
function usePermission(permissionDesc, options = {}) {
  ...
  const permissionStatus = (0, import_vue2.shallowRef)()
  const desc =
    typeof permissionDesc === 'string'
      ? { name: permissionDesc }
      : permissionDesc
  const state = (0, import_vue2.shallowRef)()
  const update = () => {
    var _a, _b
    state.value =
  ...
  const query = createSingletonPromise(async () => {
    ...
    if (controls) return (0, import_vue2.toRaw)(permissionStatus.value)
  })
  query()
  if (controls) {
    return {
...
function useClipboard(options = {}) {
  ...
  const isSupported = (0, import_vue2.computed)(
    () => isClipboardApiSupported.value || legacy
  )
  const text = (0, import_vue2.shallowRef)('')
  const copied = (0, import_vue2.shallowRef)(false)
  ...
  async function copy(value = (0, import_vue2.toValue)(source)) {
...
function useClipboardItems(options = {}) {
  ...
  const content = (0, import_vue2.ref)([])
  const copied = (0, import_vue2.shallowRef)(false)
  const timeout = useTimeoutFn(() => (copied.value = false), copiedDuring, {
    immediate: false,
  })
...
function useCloned(source, options = {}) {
  ...
  const isModified = (0, import_vue2.shallowRef)(false)
  let _lastSync = false
  const {
    manual,
    clone = cloneFnJSON,
  ...
  function sync() {
    ...
    cloned.value = clone((0, import_vue2.toValue)(source))
  }
  if (
    !manual &&
    ((0, import_vue2.isRef)(source) || typeof source === 'function')
  ) {
...
function useStorage(key, defaults2, storage, options = {}) {
  ...
  const data = (shallow ? import_vue2.shallowRef : import_vue2.ref)(
    typeof defaults2 === 'function' ? defaults2() : defaults2
  )
  const keyComputed = (0, import_vue2.computed)(() =>
    (0, import_vue2.toValue)(key)
  )
  if (!storage) {
    try {
  ...
  const rawInit = (0, import_vue2.toValue)(defaults2)
  ...
  ;(0, import_vue2.watch)(keyComputed, () => update(), { flush })
  ...
  function update(event) {
    ...
    try {
      ...
      if (event) (0, import_vue2.nextTick)(resumeWatch)
      else resumeWatch()
    }
  }
...
function useColorMode(options = {}) {
  ...
  const system = (0, import_vue2.computed)(() =>
  ...
  ;(0, import_vue2.watch)(state, onChanged, { flush: 'post', immediate: true })
  tryOnMounted(() => onChanged(state.value))
  const auto = (0, import_vue2.computed)({
    get() {
...
function useConfirmDialog(revealed = (0, import_vue2.shallowRef)(false)) {
  ...
  return {
    isRevealed: (0, import_vue2.computed)(() => revealed.value),
    reveal,
    confirm,
    cancel,
...
function useCountdown(initialCountdown, options) {
  var _a, _b
  const remaining = (0, import_vue2.shallowRef)(
    (0, import_vue2.toValue)(initialCountdown)
  )
  ...
  const reset = (countdown) => {
    var _a2
    remaining.value =
      (_a2 = (0, import_vue2.toValue)(countdown)) != null
        ? _a2
        : (0, import_vue2.toValue)(initialCountdown)
  }
  const stop = () => {
...
function useCssVar(prop, target, options = {}) {
  ...
  const variable = (0, import_vue2.shallowRef)(initialValue)
  const elRef = (0, import_vue2.computed)(() => {
    var _a
    return (
      unrefElement(target) ||
  ...
  function updateCssVar() {
    var _a
    const key = (0, import_vue2.toValue)(prop)
    const el = (0, import_vue2.toValue)(elRef)
    if (el && window2 && key) {
      const value =
  ...
  ;(0, import_vue2.watch)(
    [elRef, () => (0, import_vue2.toValue)(prop)],
    (_, old) => {
  ...
  ;(0, import_vue2.watch)(
    [variable, elRef],
    ([val, el]) => {
      const raw_prop = (0, import_vue2.toValue)(prop)
...
function useCurrentElement(rootComponent) {
  ...
  ;(0, import_vue2.onUpdated)(currentElement.trigger)
  ;(0, import_vue2.onMounted)(currentElement.trigger)
  return currentElement
}
function useCycleList(list, options) {
  const state = (0, import_vue2.shallowRef)(getInitialValue())
  const listRef = toRef(list)
  const index = (0, import_vue2.computed)({
    get() {
      var _a
  ...
  function getInitialValue() {
    var _a, _b
    return (_b = (0, import_vue2.toValue)(
      (_a = options == null ? void 0 : options.initialValue) != null
        ? _a
        : (0, import_vue2.toValue)(list)[0]
    )) != null
      ? _b
      : void 0
  }
  ;(0, import_vue2.watch)(listRef, () => set2(index.value))
  return {
    state,
    index,
    next,
...
function useDark(options = {}) {
  ...
  const system = (0, import_vue2.computed)(() => mode.system.value)
  const isDark = (0, import_vue2.computed)({
    get() {
...
function useManualRefHistory(source, options = {}) {
  ...
  function _createHistoryRecord() {
    return (0, import_vue2.markRaw)({
      snapshot: dump(source.value),
      timestamp: timestamp(),
    })
  }
  const last = (0, import_vue2.ref)(_createHistoryRecord())
  const undoStack = (0, import_vue2.ref)([])
  const redoStack = (0, import_vue2.ref)([])
  ...
  const history = (0, import_vue2.computed)(() => [
    last.value,
    ...undoStack.value,
  ])
  const canUndo = (0, import_vue2.computed)(() => undoStack.value.length > 0)
  const canRedo = (0, import_vue2.computed)(() => redoStack.value.length > 0)
  return {
    source,
    undoStack,
    redoStack,
...
function useDeviceMotion(options = {}) {
  ...
  const permissionGranted = (0, import_vue2.shallowRef)(false)
  const acceleration = (0, import_vue2.ref)({ x: null, y: null, z: null })
  const rotationRate = (0, import_vue2.ref)({
    alpha: null,
    beta: null,
    gamma: null,
  })
  const interval = (0, import_vue2.shallowRef)(0)
  const accelerationIncludingGravity = (0, import_vue2.ref)({
    x: null,
    y: null,
    z: null,
  })
...
function useDeviceOrientation(options = {}) {
  ...
  const isAbsolute = (0, import_vue2.shallowRef)(false)
  const alpha = (0, import_vue2.shallowRef)(null)
  const beta = (0, import_vue2.shallowRef)(null)
  const gamma = (0, import_vue2.shallowRef)(null)
...
function useDevicePixelRatio(options = {}) {
  const { window: window2 = defaultWindow } = options
  const pixelRatio = (0, import_vue2.shallowRef)(1)
  ...
  return {
    pixelRatio: (0, import_vue2.readonly)(pixelRatio),
    stop,
  }
}
function useDevicesList(options = {}) {
  ...
  const devices = (0, import_vue2.ref)([])
  const videoInputs = (0, import_vue2.computed)(() =>
    devices.value.filter((i) => i.kind === 'videoinput')
  )
  const audioInputs = (0, import_vue2.computed)(() =>
    devices.value.filter((i) => i.kind === 'audioinput')
  )
  const audioOutputs = (0, import_vue2.computed)(() =>
...
function useDisplayMedia(options = {}) {
  var _a
  const enabled = (0, import_vue2.shallowRef)(
  ...
  const stream = (0, import_vue2.shallowRef)()
...
function useDocumentVisibility(options = {}) {
  const { document: document2 = defaultDocument } = options
  if (!document2) return (0, import_vue2.shallowRef)('visible')
  const visibility = (0, import_vue2.shallowRef)(document2.visibilityState)
  useEventListener(
    document2,
    'visibilitychange',
    () => {
...
function useDraggable(target, options = {}) {
  ...
  const position = (0, import_vue2.ref)(
    (_a = (0, import_vue2.toValue)(initialValue)) != null ? _a : { x: 0, y: 0 }
  )
  const pressedDelta = (0, import_vue2.ref)()
  const filterEvent = (e) => {
    if (pointerTypes) return pointerTypes.includes(e.pointerType)
    return true
  }
  const handleEvent = (e) => {
    if ((0, import_vue2.toValue)(preventDefault2)) e.preventDefault()
    if ((0, import_vue2.toValue)(stopPropagation)) e.stopPropagation()
  }
  const start = (e) => {
    var _a2
    if (!(0, import_vue2.toValue)(buttons).includes(e.button)) return
    if ((0, import_vue2.toValue)(options.disabled) || !filterEvent(e)) return
    if (
      (0, import_vue2.toValue)(exact) &&
      e.target !== (0, import_vue2.toValue)(target)
    )
      return
    const container = (0, import_vue2.toValue)(containerElement)
    const containerRect =
      (_a2 = container == null ? void 0 : container.getBoundingClientRect) ==
      null
        ? void 0
        : _a2.call(container)
    const targetRect = (0, import_vue2.toValue)(target).getBoundingClientRect()
    const pos = {
      x:
        e.clientX -
        (container
  ...
  if (isClient) {
    const config = () => {
      ...
      return {
        ...
        passive: !(0, import_vue2.toValue)(preventDefault2),
      }
    }
  ...
  return {
    ...toRefs(position),
    position,
    isDragging: (0, import_vue2.computed)(() => !!pressedDelta.value),
    style: (0, import_vue2.computed)(
...
function useDropZone(target, options = {}) {
  var _a, _b
  const isOverDropZone = (0, import_vue2.shallowRef)(false)
  const files = (0, import_vue2.shallowRef)(null)
  let counter = 0
  let isValid = true
  if (isClient) {
    const _options =
    ...
    const checkDataTypes = (types) => {
      const dataTypes = (0, import_vue2.unref)(_options.dataTypes)
...
function useResizeObserver(target, callback, options = {}) {
  ...
  const targets = (0, import_vue2.computed)(() => {
    const _targets = (0, import_vue2.toValue)(target)
...
function useElementBounding(target, options = {}) {
  ...
  const height = (0, import_vue2.shallowRef)(0)
  const bottom = (0, import_vue2.shallowRef)(0)
  const left = (0, import_vue2.shallowRef)(0)
  const right = (0, import_vue2.shallowRef)(0)
  const top = (0, import_vue2.shallowRef)(0)
  const width = (0, import_vue2.shallowRef)(0)
  const x = (0, import_vue2.shallowRef)(0)
  const y = (0, import_vue2.shallowRef)(0)
...
function useElementByPoint(options) {
  ...
  const isSupported = useSupported(() => {
    if ((0, import_vue2.toValue)(multiple))
      return document2 && 'elementsFromPoint' in document2
    return document2 && 'elementFromPoint' in document2
  })
  const element = (0, import_vue2.shallowRef)(null)
  const cb = () => {
    var _a, _b
    element.value = (0, import_vue2.toValue)(multiple)
      ? (_a =
          document2 == null
            ? void 0
            : document2.elementsFromPoint(
                (0, import_vue2.toValue)(x),
                (0, import_vue2.toValue)(y)
              )) != null
        ? _a
        : []
      : (_b =
...
function useElementHover(el, options = {}) {
  ...
  const isHovered = (0, import_vue2.shallowRef)(false)
  let timer
  ...
  if (triggerOnRemoval) {
    onElementRemoval(
      (0, import_vue2.computed)(() => unrefElement(el)),
      () => toggle(false)
    )
  }
  return isHovered
...
function useElementSize(
  ...
  const isSVG = (0, import_vue2.computed)(() => {
    var _a, _b
    return (_b =
  ...
  const width = (0, import_vue2.shallowRef)(initialSize.width)
  const height = (0, import_vue2.shallowRef)(initialSize.height)
  ...
  const stop2 = (0, import_vue2.watch)(
    () => unrefElement(target),
    (ele) => {
...
function useIntersectionObserver(target, callback, options = {}) {
  ...
  let cleanup = noop
  const isActive = (0, import_vue2.shallowRef)(immediate)
...
function useElementVisibility(element, options = {}) {
  ...
  const elementIsVisible = (0, import_vue2.shallowRef)(false)
  const { stop } = useIntersectionObserver(
    ...
    },
    {
      ...
      window: window2,
      threshold,
      rootMargin: (0, import_vue2.toValue)(rootMargin),
    }
  )
...
function useEventBus(key) {
  const scope = (0, import_vue2.getCurrentScope)()
...
function useEventSource(url, events2 = [], options = {}) {
  const event = (0, import_vue2.shallowRef)(null)
  const data = (0, import_vue2.shallowRef)(null)
  const status = (0, import_vue2.shallowRef)('CONNECTING')
  const eventSource = (0, import_vue2.ref)(null)
  const error = (0, import_vue2.shallowRef)(null)
  const urlRef = toRef(url)
  const lastEventId = (0, import_vue2.shallowRef)(null)
  ...
  if (immediate) open()
  if (autoConnect) (0, import_vue2.watch)(urlRef, open)
...
function useEyeDropper(options = {}) {
  ...
  const sRGBHex = (0, import_vue2.shallowRef)(initialValue)
...
function createFetch(config = {}) {
  ...
  function useFactoryFetch(url, ...args) {
    const computedUrl = (0, import_vue2.computed)(() => {
      const baseUrl = (0, import_vue2.toValue)(config.baseUrl)
      const targetUrl = (0, import_vue2.toValue)(url)
...
function useFetch(url, ...args) {
  ...
  const isFinished = (0, import_vue2.shallowRef)(false)
  const isFetching = (0, import_vue2.shallowRef)(false)
  const aborted = (0, import_vue2.shallowRef)(false)
  const statusCode = (0, import_vue2.shallowRef)(null)
  const response = (0, import_vue2.shallowRef)(null)
  const error = (0, import_vue2.shallowRef)(null)
  const data = (0, import_vue2.shallowRef)(initialData || null)
  const canAbort = (0, import_vue2.computed)(
    () => supportsAbort && isFetching.value
  )
  let controller
  let timer
  const abort = () => {
  ...
  const execute = async (throwOnFailed = false) => {
    ...
    const payload = (0, import_vue2.toValue)(config.payload)
    if (payload) {
  ...
  const shell = {
    isFinished: (0, import_vue2.readonly)(isFinished),
    isFetching: (0, import_vue2.readonly)(isFetching),
    statusCode,
    response,
    error,
    data,
  ...
  function setMethod(method) {
    return (payload, payloadType) => {
      if (!isFetching.value) {
        ...
        if ((0, import_vue2.isRef)(config.payload)) {
          ;(0, import_vue2.watch)(
...
function useFileDialog(options = {}) {
  const { document: document2 = defaultDocument } = options
  const files = (0, import_vue2.ref)(prepareInitialFiles(options.initialFiles))
  ...
  return {
    files: (0, import_vue2.readonly)(files),
    open,
    reset,
    onCancel,
    onChange,
...
function useFileSystemAccess(options = {}) {
  ...
  const fileHandle = (0, import_vue2.shallowRef)()
  const data = (0, import_vue2.shallowRef)()
  const file = (0, import_vue2.shallowRef)()
  const fileName = (0, import_vue2.computed)(() => {
    var _a, _b
    return (_b = (_a = file.value) == null ? void 0 : _a.name) != null ? _b : ''
  })
  const fileMIME = (0, import_vue2.computed)(() => {
    var _a, _b
    return (_b = (_a = file.value) == null ? void 0 : _a.type) != null ? _b : ''
  })
  const fileSize = (0, import_vue2.computed)(() => {
    var _a, _b
    return (_b = (_a = file.value) == null ? void 0 : _a.size) != null ? _b : 0
  })
  const fileLastModified = (0, import_vue2.computed)(() => {
    var _a, _b
  ...
  async function updateData() {
    var _a, _b
    await updateFile()
    const type = (0, import_vue2.toValue)(dataType)
    if (type === 'Text')
  ...
  ;(0, import_vue2.watch)(() => (0, import_vue2.toValue)(dataType), updateData)
  return {
    isSupported,
    data,
    file,
...
function useFocus(target, options = {}) {
  ...
  const innerFocused = (0, import_vue2.shallowRef)(false)
  const targetElement = (0, import_vue2.computed)(() => unrefElement(target))
  const listenerOptions = { passive: true }
  useEventListener(
    targetElement,
    'focus',
  ...
  const focused = (0, import_vue2.computed)({
...
function useFocusWithin(target, options = {}) {
  const { window: window2 = defaultWindow } = options
  const targetElement = (0, import_vue2.computed)(() => unrefElement(target))
  const _focused = (0, import_vue2.shallowRef)(false)
  const focused = (0, import_vue2.computed)(() => _focused.value)
...
function useFps(options) {
  var _a
  const fps = (0, import_vue2.shallowRef)(0)
...
function useFullscreen(target, options = {}) {
  ...
  const targetRef = (0, import_vue2.computed)(() => {
    var _a
  ...
  const isFullscreen = (0, import_vue2.shallowRef)(false)
  const requestMethod = (0, import_vue2.computed)(() => {
    return [
      'requestFullscreen',
  ...
  const exitMethod = (0, import_vue2.computed)(() => {
    return [
      'exitFullscreen',
  ...
  const fullscreenEnabled = (0, import_vue2.computed)(() => {
    return [
      'fullScreen',
      'webkitIsFullScreen',
...
function useGamepad(options = {}) {
  ...
  const gamepads = (0, import_vue2.ref)([])
...
function useGeolocation(options = {}) {
  ...
  const locatedAt = (0, import_vue2.shallowRef)(null)
  const error = (0, import_vue2.shallowRef)(null)
  const coords = (0, import_vue2.ref)({
    accuracy: 0,
...
function useIdle(timeout = oneMinute, options = {}) {
  ...
  const idle = (0, import_vue2.shallowRef)(initialState)
  const lastActive = (0, import_vue2.shallowRef)(timestamp())
  let timer
  const reset = () => {
    idle.value = false
    clearTimeout(timer)
...
function useImage(options, asyncStateOptions = {}) {
  const state = useAsyncState(
    () => loadImage((0, import_vue2.toValue)(options)),
    void 0,
    {
      resetOnExecute: true,
      ...asyncStateOptions,
...
function useScroll(element, options = {}) {
  ...
  const internalX = (0, import_vue2.shallowRef)(0)
  const internalY = (0, import_vue2.shallowRef)(0)
  const x = (0, import_vue2.computed)({
    get() {
  ...
  const y = (0, import_vue2.computed)({
    get() {
  ...
  function scrollTo(_x, _y) {
    var _a, _b, _c, _d
    if (!window2) return
    const _element = (0, import_vue2.toValue)(element)
    if (!_element) return
    ;(_c = _element instanceof Document ? window2.document.body : _element) ==
    null
      ? void 0
      : _c.scrollTo({
          top: (_a = (0, import_vue2.toValue)(_y)) != null ? _a : y.value,
          left: (_b = (0, import_vue2.toValue)(_x)) != null ? _b : x.value,
          behavior: (0, import_vue2.toValue)(behavior),
        })
  ...
  const isScrolling = (0, import_vue2.shallowRef)(false)
  const arrivedState = (0, import_vue2.reactive)({
    left: true,
    right: false,
    top: true,
    bottom: false,
  })
  const directions = (0, import_vue2.reactive)({
    left: false,
    right: false,
    top: false,
    bottom: false,
...
function useInfiniteScroll(element, onLoadMore, options = {}) {
  ...
  const promise = (0, import_vue2.ref)()
  const isLoading = (0, import_vue2.computed)(() => !!promise.value)
  const observedElement = (0, import_vue2.computed)(() => {
    return resolveElement((0, import_vue2.toValue)(element))
  })
    ...
    if (state.arrivedState[direction] || isNarrower) {
      if (!promise.value) {
        promise.value = Promise.all([
          ...
          promise.value = null
          ;(0, import_vue2.nextTick)(() => checkAndLoad())
        })
      }
    }
  }
...
function useKeyModifier(modifier, options = {}) {
  ...
  const state = (0, import_vue2.shallowRef)(initial)
  if (document2) {
...
function useMagicKeys(options = {}) {
  ...
  const current = (0, import_vue2.reactive)(/* @__PURE__ */ new Set())
  const obj = {
    toJSON() {
      return {}
    },
  ...
  const refs = useReactive ? (0, import_vue2.reactive)(obj) : obj
    ...
    get(target2, prop, rec) {
      ...
      if (!(prop in refs)) {
        if (/[+_-]/.test(prop)) {
          ...
          refs[prop] = (0, import_vue2.computed)(() =>
            keys2
              .map((key) => (0, import_vue2.toValue)(proxy[key]))
              .every(Boolean)
          )
        } else {
          refs[prop] = (0, import_vue2.shallowRef)(false)
        }
      }
      const r = Reflect.get(target2, prop, rec)
      return useReactive ? (0, import_vue2.toValue)(r) : r
    },
  })
  return proxy
}
function usingElRef(source, cb) {
  if ((0, import_vue2.toValue)(source)) cb((0, import_vue2.toValue)(source))
}
...
function useMediaControls(target, options = {}) {
  ...
  const { document: document2 = defaultDocument } = options
  const listenerOptions = { passive: true }
  const currentTime = (0, import_vue2.shallowRef)(0)
  const duration = (0, import_vue2.shallowRef)(0)
  const seeking = (0, import_vue2.shallowRef)(false)
  const volume = (0, import_vue2.shallowRef)(1)
  const waiting = (0, import_vue2.shallowRef)(false)
  const ended = (0, import_vue2.shallowRef)(false)
  const playing = (0, import_vue2.shallowRef)(false)
  const rate = (0, import_vue2.shallowRef)(1)
  const stalled = (0, import_vue2.shallowRef)(false)
  const buffered = (0, import_vue2.ref)([])
  const tracks = (0, import_vue2.ref)([])
  const selectedTrack = (0, import_vue2.shallowRef)(-1)
  const isPictureInPicture = (0, import_vue2.shallowRef)(false)
  const muted = (0, import_vue2.shallowRef)(false)
  ...
  ;(0, import_vue2.watchEffect)(() => {
    if (!document2) return
    const el = (0, import_vue2.toValue)(target)
    if (!el) return
    const src = (0, import_vue2.toValue)(options.src)
    let sources = []
    if (!src) return
  ...
  ;(0, import_vue2.watch)([target, volume], () => {
    const el = (0, import_vue2.toValue)(target)
    if (!el) return
    el.volume = volume.value
  })
  ;(0, import_vue2.watch)([target, muted], () => {
    const el = (0, import_vue2.toValue)(target)
    if (!el) return
    el.muted = muted.value
  })
  ;(0, import_vue2.watch)([target, rate], () => {
    const el = (0, import_vue2.toValue)(target)
    if (!el) return
  ...
  ;(0, import_vue2.watchEffect)(() => {
    if (!document2) return
    const textTracks = (0, import_vue2.toValue)(options.tracks)
    const el = (0, import_vue2.toValue)(target)
  ...
  useEventListener(
    ...
    () =>
      ignoreCurrentTimeUpdates(
        () => (currentTime.value = (0, import_vue2.toValue)(target).currentTime)
      ),
    listenerOptions
  )
  useEventListener(
    target,
    'durationchange',
    () => (duration.value = (0, import_vue2.toValue)(target).duration),
    listenerOptions
  )
  useEventListener(
    target,
    ...
    () =>
      (buffered.value = timeRangeToArray(
        (0, import_vue2.toValue)(target).buffered
      )),
    listenerOptions
  )
  useEventListener(
  ...
  useEventListener(
    target,
    'ratechange',
    () => (rate.value = (0, import_vue2.toValue)(target).playbackRate),
    listenerOptions
  )
  useEventListener(
    target,
  ...
  const listeners = []
  const stop = (0, import_vue2.watch)([target], () => {
    const el = (0, import_vue2.toValue)(target)
    if (!el) return
    stop()
...
function useMemoize(resolver, options) {
  const initCache = () => {
    if (options == null ? void 0 : options.cache)
      return (0, import_vue2.shallowReactive)(options.cache)
    return (0, import_vue2.shallowReactive)(/* @__PURE__ */ new Map())
  }
...
function useMemory(options = {}) {
  const memory = (0, import_vue2.ref)()
  const isSupported = useSupported(
...
function useMouse(options = {}) {
  ...
  let _prevScrollX = 0
  let _prevScrollY = 0
  const x = (0, import_vue2.shallowRef)(initialValue.x)
  const y = (0, import_vue2.shallowRef)(initialValue.y)
  const sourceType = (0, import_vue2.shallowRef)(null)
  const extractor =
...
function useMouseInElement(target, options = {}) {
  ...
  const targetRef = (0, import_vue2.shallowRef)(
    target != null ? target : window2 == null ? void 0 : window2.document.body
  )
  const elementX = (0, import_vue2.shallowRef)(0)
  const elementY = (0, import_vue2.shallowRef)(0)
  const elementPositionX = (0, import_vue2.shallowRef)(0)
  const elementPositionY = (0, import_vue2.shallowRef)(0)
  const elementHeight = (0, import_vue2.shallowRef)(0)
  const elementWidth = (0, import_vue2.shallowRef)(0)
  const isOutside = (0, import_vue2.shallowRef)(true)
  let stop = () => {}
  if (window2) {
    stop = (0, import_vue2.watch)(
      [targetRef, x, y],
      () => {
...
function useMousePressed(options = {}) {
  ...
  const pressed = (0, import_vue2.shallowRef)(initialValue)
  const sourceType = (0, import_vue2.shallowRef)(null)
  if (!window2) {
    return {
      pressed,
  ...
  const target = (0, import_vue2.computed)(
    () => unrefElement(options.target) || window2
  )
...
function useNavigatorLanguage(options = {}) {
  ...
  const language = (0, import_vue2.shallowRef)(
...
function useNetwork(options = {}) {
  ...
  const isOnline = (0, import_vue2.shallowRef)(true)
  const saveData = (0, import_vue2.shallowRef)(false)
  const offlineAt = (0, import_vue2.shallowRef)(void 0)
  const onlineAt = (0, import_vue2.shallowRef)(void 0)
  const downlink = (0, import_vue2.shallowRef)(void 0)
  const downlinkMax = (0, import_vue2.shallowRef)(void 0)
  const rtt = (0, import_vue2.shallowRef)(void 0)
  const effectiveType = (0, import_vue2.shallowRef)(void 0)
  const type = (0, import_vue2.shallowRef)('unknown')
  ...
  return {
    isSupported,
    isOnline: (0, import_vue2.readonly)(isOnline),
    saveData: (0, import_vue2.readonly)(saveData),
    offlineAt: (0, import_vue2.readonly)(offlineAt),
    onlineAt: (0, import_vue2.readonly)(onlineAt),
    downlink: (0, import_vue2.readonly)(downlink),
    downlinkMax: (0, import_vue2.readonly)(downlinkMax),
    effectiveType: (0, import_vue2.readonly)(effectiveType),
    rtt: (0, import_vue2.readonly)(rtt),
    type: (0, import_vue2.readonly)(type),
  }
}
function useNow(options = {}) {
  ...
  const now2 = (0, import_vue2.ref)(/* @__PURE__ */ new Date())
...
function useObjectUrl(object) {
  const url = (0, import_vue2.shallowRef)()
  const release = () => {
    if (url.value) URL.revokeObjectURL(url.value)
    url.value = void 0
  }
  ;(0, import_vue2.watch)(
    () => (0, import_vue2.toValue)(object),
    (newObject) => {
      release()
  ...
  return (0, import_vue2.readonly)(url)
}
function useClamp(value, min, max) {
  if (typeof value === 'function' || (0, import_vue2.isReadonly)(value))
    return (0, import_vue2.computed)(() =>
      clamp(
        (0, import_vue2.toValue)(value),
        (0, import_vue2.toValue)(min),
        (0, import_vue2.toValue)(max)
      )
    )
  const _value = (0, import_vue2.ref)(value)
  return (0, import_vue2.computed)({
    get() {
...
function useOffsetPagination(options) {
  ...
  const pageCount = (0, import_vue2.computed)(() =>
    Math.max(
      1,
      Math.ceil(
        (0, import_vue2.toValue)(total) /
          (0, import_vue2.toValue)(currentPageSize)
      )
    )
  )
  const currentPage = useClamp(page, 1, pageCount)
  const isFirstPage = (0, import_vue2.computed)(() => currentPage.value === 1)
  const isLastPage = (0, import_vue2.computed)(
    () => currentPage.value === pageCount.value
  )
  if ((0, import_vue2.isRef)(page)) {
    syncRef(page, currentPage, {
      direction: (0, import_vue2.isReadonly)(page) ? 'ltr' : 'both',
    })
  }
  if ((0, import_vue2.isRef)(pageSize)) {
    syncRef(pageSize, currentPageSize, {
      direction: (0, import_vue2.isReadonly)(pageSize) ? 'ltr' : 'both',
    })
  }
  function prev() {
    currentPage.value--
  ...
  ;(0, import_vue2.watch)(currentPage, () => {
    onPageChange((0, import_vue2.reactive)(returnValue))
  })
  ;(0, import_vue2.watch)(currentPageSize, () => {
    onPageSizeChange((0, import_vue2.reactive)(returnValue))
  })
  ;(0, import_vue2.watch)(pageCount, () => {
    onPageCountChange((0, import_vue2.reactive)(returnValue))
  })
  return returnValue
}
...
function usePageLeave(options = {}) {
  const { window: window2 = defaultWindow } = options
  const isLeft = (0, import_vue2.shallowRef)(false)
  const handler = (event) => {
    if (!window2) return
...
function useScreenOrientation(options = {}) {
  ...
  const orientation = (0, import_vue2.ref)(screenOrientation.type)
  const angle = (0, import_vue2.shallowRef)(screenOrientation.angle || 0)
  if (isSupported.value) {
    useEventListener(
      window2,
      'orientationchange',
...
function useParallax(target, options = {}) {
  ...
  const orientation = (0, import_vue2.reactive)(
    useDeviceOrientation({ window: window2 })
  )
  const screenOrientation = (0, import_vue2.reactive)(
  ...
  const source = (0, import_vue2.computed)(() => {
    if (
  ...
  const roll = (0, import_vue2.computed)(() => {
  ...
  const tilt = (0, import_vue2.computed)(() => {
    if (source.value === 'deviceOrientation') {
      let value
      switch (screenOrientation.orientation) {
        case 'landscape-primary':
...
function useParentElement(element = useCurrentElement()) {
  const parentElement = (0, import_vue2.shallowRef)()
  const update = () => {
    const el = unrefElement(element)
    if (el) parentElement.value = el.parentElement
  }
  tryOnMounted(update)
  ;(0, import_vue2.watch)(() => (0, import_vue2.toValue)(element), update)
...
function usePointer(options = {}) {
  ...
  const isInside = (0, import_vue2.shallowRef)(false)
  const state = (0, import_vue2.ref)(options.initialValue || {})
...
function usePointerLock(target, options = {}) {
  ...
  const element = (0, import_vue2.shallowRef)()
  const triggerElement = (0, import_vue2.shallowRef)()
  let targetElement
  if (isSupported.value) {
    const listenerOptions = { passive: true }
    useEventListener(
...
function usePointerSwipe(target, options = {}) {
  ...
  const posStart = (0, import_vue2.reactive)({ x: 0, y: 0 })
  const updatePosStart = (x, y) => {
    posStart.x = x
    posStart.y = y
  }
  const posEnd = (0, import_vue2.reactive)({ x: 0, y: 0 })
  const updatePosEnd = (x, y) => {
    posEnd.x = x
    posEnd.y = y
  }
  const distanceX = (0, import_vue2.computed)(() => posStart.x - posEnd.x)
  const distanceY = (0, import_vue2.computed)(() => posStart.y - posEnd.y)
  const { max, abs } = Math
  const isThresholdExceeded = (0, import_vue2.computed)(
    () => max(abs(distanceX.value), abs(distanceY.value)) >= threshold
  )
  const isSwiping = (0, import_vue2.shallowRef)(false)
  const isPointerDown = (0, import_vue2.shallowRef)(false)
  const direction = (0, import_vue2.computed)(() => {
  ...
  return {
    isSwiping: (0, import_vue2.readonly)(isSwiping),
    direction: (0, import_vue2.readonly)(direction),
    posStart: (0, import_vue2.readonly)(posStart),
    posEnd: (0, import_vue2.readonly)(posEnd),
    distanceX,
    distanceY,
    stop,
  }
...
function usePreferredLanguages(options = {}) {
  const { window: window2 = defaultWindow } = options
  if (!window2) return (0, import_vue2.ref)(['en'])
  const navigator2 = window2.navigator
  const value = (0, import_vue2.ref)(navigator2.languages)
  useEventListener(
    window2,
    'languagechange',
    () => {
...
function usePrevious(value, initialValue) {
  const previous = (0, import_vue2.shallowRef)(initialValue)
  ;(0, import_vue2.watch)(
    toRef(value),
    (_, oldValue) => {
  ...
  return (0, import_vue2.readonly)(previous)
}
...
function useScreenSafeArea() {
  const top = (0, import_vue2.shallowRef)('')
  const right = (0, import_vue2.shallowRef)('')
  const bottom = (0, import_vue2.shallowRef)('')
  const left = (0, import_vue2.shallowRef)('')
  if (isClient) {
...
function useScriptTag(src, onLoaded = noop, options = {}) {
  ...
  const scriptTag = (0, import_vue2.shallowRef)(null)
  let _promise = null
  const loadScript = (waitForScriptLoad) =>
    new Promise((resolve, reject) => {
      ...
      let el = document2.querySelector(
        `script[src="${(0, import_vue2.toValue)(src)}"]`
      )
      if (!el) {
        el = document2.createElement('script')
        el.type = type
        el.async = async
        el.src = (0, import_vue2.toValue)(src)
...
function useScrollLock(element, initialState = false) {
  const isLocked = (0, import_vue2.shallowRef)(initialState)
  let stopTouchMoveListener = null
  let initialOverflow = ''
  ;(0, import_vue2.watch)(
    toRef(element),
    (el) => {
      const target = resolveElement((0, import_vue2.toValue)(el))
      if (target) {
        const ele = target
  ...
  const lock = () => {
    const el = resolveElement((0, import_vue2.toValue)(element))
...
function useShare(shareOptions = {}, options = {}) {
  ...
  const share = async (overrideOptions = {}) => {
    if (isSupported.value) {
      const data = {
        ...(0, import_vue2.toValue)(shareOptions),
        ...(0, import_vue2.toValue)(overrideOptions),
      }
      let granted = true
...
function useSorted(...args) {
  ...
  if (!dirty)
    return (0, import_vue2.computed)(() =>
      sortFn([...(0, import_vue2.toValue)(source)], compareFn)
    )
  ;(0, import_vue2.watchEffect)(() => {
    const result = sortFn((0, import_vue2.toValue)(source), compareFn)
    if ((0, import_vue2.isRef)(source)) source.value = result
...
function useSpeechRecognition(options = {}) {
  ...
  const isListening = (0, import_vue2.shallowRef)(false)
  const isFinal = (0, import_vue2.shallowRef)(false)
  ...
  if (isSupported.value) {
    ...
    recognition.lang = (0, import_vue2.toValue)(lang)
    recognition.maxAlternatives = maxAlternatives
    recognition.onstart = () => {
      isListening.value = true
      isFinal.value = false
    }
    ;(0, import_vue2.watch)(lang, (lang2) => {
    ...
    ;(0, import_vue2.watch)(isListening, (newValue, oldValue) => {
...
function useSpeechSynthesis(text, options = {}) {
  ...
  const isPlaying = (0, import_vue2.shallowRef)(false)
  const status = (0, import_vue2.shallowRef)('init')
  ...
  const bindEventsForUtterance = (utterance2) => {
    utterance2.lang = (0, import_vue2.toValue)(lang)
    utterance2.voice = (0, import_vue2.toValue)(options.voice) || null
    utterance2.pitch = (0, import_vue2.toValue)(pitch)
    utterance2.rate = (0, import_vue2.toValue)(rate)
  ...
  const utterance = (0, import_vue2.computed)(() => {
    isPlaying.value = false
    status.value = 'init'
  ...
  if (isSupported.value) {
    ...
    if (options.voice) {
      ;(0, import_vue2.watch)(options.voice, () => {
        synth.cancel()
      })
    }
    ;(0, import_vue2.watch)(isPlaying, () => {
...
function useStepper(steps, initialStep) {
  const stepsRef = (0, import_vue2.ref)(steps)
  const stepNames = (0, import_vue2.computed)(() =>
    Array.isArray(stepsRef.value) ? stepsRef.value : Object.keys(stepsRef.value)
  )
  const index = (0, import_vue2.ref)(
    stepNames.value.indexOf(
      initialStep != null ? initialStep : stepNames.value[0]
    )
  )
  const current = (0, import_vue2.computed)(() => at(index.value))
  const isFirst = (0, import_vue2.computed)(() => index.value === 0)
  const isLast = (0, import_vue2.computed)(
    () => index.value === stepNames.value.length - 1
  )
  const next = (0, import_vue2.computed)(() => stepNames.value[index.value + 1])
  const previous = (0, import_vue2.computed)(
    () => stepNames.value[index.value - 1]
  )
  function at(index2) {
...
function useStorageAsync(key, initialValue, storage, options = {}) {
  ...
  const rawInit = (0, import_vue2.toValue)(initialValue)
  const type = guessSerializerType(rawInit)
  const data = (shallow ? import_vue2.shallowRef : import_vue2.ref)(
    (0, import_vue2.toValue)(initialValue)
  )
  const serializer =
    (_a = options.serializer) != null ? _a : StorageSerializers[type]
  if (!storage) {
...
function useStyleTag(css, options = {}) {
  const isLoaded = (0, import_vue2.shallowRef)(false)
  const {
    document: document2 = defaultDocument,
    immediate = true,
    manual = false,
  ...
  const cssRef = (0, import_vue2.shallowRef)(css)
  let stop = () => {}
  const load = () => {
    if (!document2) return
...
function useSwipe(target, options = {}) {
  ...
  const coordsStart = (0, import_vue2.reactive)({ x: 0, y: 0 })
  const coordsEnd = (0, import_vue2.reactive)({ x: 0, y: 0 })
  const diffX = (0, import_vue2.computed)(() => coordsStart.x - coordsEnd.x)
  const diffY = (0, import_vue2.computed)(() => coordsStart.y - coordsEnd.y)
  const { max, abs } = Math
  const isThresholdExceeded = (0, import_vue2.computed)(
...
function useTextDirection(options = {}) {
  ...
  const dir = (0, import_vue2.ref)(getValue2())
...
function useTextSelection(options = {}) {
  const { window: window2 = defaultWindow } = options
  const selection = (0, import_vue2.ref)(null)
  const text = (0, import_vue2.computed)(() => {
    var _a, _b
  ...
  const rects = (0, import_vue2.computed)(() =>
...
function useTextareaAutosize(options = {}) {
  ...
  const textareaScrollHeight = (0, import_vue2.shallowRef)(1)
  const textareaOldWidth = (0, import_vue2.shallowRef)(0)
  function triggerResize() {
    ...
    const _styleTarget = (0, import_vue2.toValue)(
  ...
  ;(0, import_vue2.watch)(
    [input, textarea],
    () => (0, import_vue2.nextTick)(triggerResize),
    { immediate: true }
  )
  ;(0, import_vue2.watch)(textareaScrollHeight, () => {
    var _a2
  ...
  if (options == null ? void 0 : options.watch)
    (0, import_vue2.watch)(options.watch, triggerResize, {
      immediate: true,
      deep: true,
    })
  return {
...
function useTimeAgo(time, options = {}) {
  ...
  const timeAgo = (0, import_vue2.computed)(() =>
    formatTimeAgo(
      new Date((0, import_vue2.toValue)(time)),
      options,
      (0, import_vue2.toValue)(now2)
    )
  )
  if (exposeControls) {
    return {
...
function useTimestamp(options = {}) {
  ...
  const ts = (0, import_vue2.shallowRef)(timestamp() + offset)
...
function useTitle(newTitle = null, options = {}) {
  ...
  function format(t) {
    ...
    return typeof template === 'function'
      ? template(t)
      : (0, import_vue2.toValue)(template).replace(/%s/g, t)
  }
  ;(0, import_vue2.watch)(
    title,
    (newValue, oldValue) => {
...
function executeTransition(source, from, to, options = {}) {
  var _a, _b
  const fromVal = (0, import_vue2.toValue)(from)
  const toVal = (0, import_vue2.toValue)(to)
  const v1 = toVec(fromVal)
  const v2 = toVec(toVal)
  const duration =
    (_a = (0, import_vue2.toValue)(options.duration)) != null ? _a : 1e3
  const startedAt = Date.now()
  const endAt = Date.now() + duration
  const trans =
    typeof options.transition === 'function'
      ? options.transition
      : (_b = (0, import_vue2.toValue)(options.transition)) != null
        ? _b
        : identity
...
function useTransition(source, options = {}) {
  let currentId = 0
  const sourceVal = () => {
    const v = (0, import_vue2.toValue)(source)
    return typeof v === 'number' ? v : v.map(import_vue2.toValue)
  }
  const outputRef = (0, import_vue2.ref)(sourceVal())
  ;(0, import_vue2.watch)(
    sourceVal,
    async (to) => {
      var _a, _b
      if ((0, import_vue2.toValue)(options.disabled)) return
      const id = ++currentId
      if (options.delay)
        await promiseTimeout((0, import_vue2.toValue)(options.delay))
      if (id !== currentId) return
      const toVal = Array.isArray(to)
        ? to.map(import_vue2.toValue)
        : (0, import_vue2.toValue)(to)
  ...
  ;(0, import_vue2.watch)(
    () => (0, import_vue2.toValue)(options.disabled),
    (disabled) => {
      if (disabled) {
        currentId++
  ...
  return (0, import_vue2.computed)(() =>
    (0, import_vue2.toValue)(options.disabled) ? sourceVal() : outputRef.value
  )
}
function useUrlSearchParams(mode = 'history', options = {}) {
  ...
  if (!window2) return (0, import_vue2.reactive)(initialValue)
  const state = (0, import_vue2.reactive)({})
...
function useUserMedia(options = {}) {
  ...
  const autoSwitch = (0, import_vue2.shallowRef)(
    (_b = options.autoSwitch) != null ? _b : true
  )
  const constraints = (0, import_vue2.ref)(options.constraints)
  const { navigator: navigator2 = defaultNavigator } = options
  const isSupported = useSupported(() => {
    var _a2
    return (_a2 = navigator2 == null ? void 0 : navigator2.mediaDevices) == null
    ...
    ;(0, import_vue2.watch)(
      ...
      (v) => {
        if (!isUpdating) {
          ...
          ;(0, import_vue2.nextTick)(() => (isUpdating = false))
        }
      }
    )
    ;(0, import_vue2.watch)(
...
function useVirtualListResources(list) {
  const containerRef = (0, import_vue2.shallowRef)(null)
  const size = useElementSize(containerRef)
  const currentList = (0, import_vue2.ref)([])
  const source = (0, import_vue2.shallowRef)(list)
  const state = (0, import_vue2.ref)({ start: 0, end: 10 })
...
function useWatchForSizes(size, list, containerRef, calculateRange) {
  ;(0, import_vue2.watch)([size.width, size.height, list, containerRef], () => {
    calculateRange()
  })
}
...
function useHorizontalVirtualList(options, list) {
  ...
  const offsetLeft = (0, import_vue2.computed)(() =>
    getDistanceLeft(state.value.start)
  )
  ...
  const wrapperProps = (0, import_vue2.computed)(() => {
    return {
      style: {
        height: '100%',
...
function useVerticalVirtualList(options, list) {
  ...
  const offsetTop = (0, import_vue2.computed)(() =>
    getDistanceTop(state.value.start)
  )
...
function useWakeLock(options = {}) {
  ...
  const requestedType = (0, import_vue2.shallowRef)(false)
  const sentinel = (0, import_vue2.shallowRef)(null)
  ...
  const isActive = (0, import_vue2.computed)(
...
function useWebNotification(options = {}) {
  ...
  const permissionGranted = (0, import_vue2.shallowRef)(
    isSupported.value &&
      'permission' in Notification &&
      Notification.permission === 'granted'
  )
  const notification = (0, import_vue2.ref)(null)
  const ensurePermissions = async () => {
    if (!isSupported.value) return
...
function useWebSocket(url, options = {}) {
  ...
  const status = (0, import_vue2.shallowRef)('CLOSED')
  const wsRef = (0, import_vue2.ref)()
  const urlRef = toRef(url)
  let heartbeatPause
  let heartbeatResume
  let explicitlyClosed = false
  ...
  const _init = () => {
    ...
    ws.onmessage = (e) => {
      if (options.heartbeat) {
        ...
        if (e.data === (0, import_vue2.toValue)(responseMessage)) return
      }
      data.value = e.data
  ...
  if (options.heartbeat) {
    ...
    const { pause, resume } = useIntervalFn(
      () => {
        send((0, import_vue2.toValue)(message), false)
...
function useWebWorker(arg0, workerOptions, options) {
  ...
  const data = (0, import_vue2.ref)(null)
  const worker = (0, import_vue2.shallowRef)()
  const post = (...args) => {
...
function useWebWorkerFn(fn, options = {}) {
  ...
  const worker = (0, import_vue2.ref)()
  const workerStatus = (0, import_vue2.shallowRef)('PENDING')
  const promise = (0, import_vue2.ref)({})
  const timeoutId = (0, import_vue2.shallowRef)()
...
function useWindowFocus(options = {}) {
  const { window: window2 = defaultWindow } = options
  if (!window2) return (0, import_vue2.shallowRef)(false)
  const focused = (0, import_vue2.shallowRef)(window2.document.hasFocus())
  const listenerOptions = { passive: true }
  useEventListener(
    window2,
    'blur',
...
function useWindowSize(options = {}) {
  ...
  const width = (0, import_vue2.shallowRef)(initialWidth)
  const height = (0, import_vue2.shallowRef)(initialHeight)
  const update = () => {
    if (window2) {
      if (type === 'outer') {
  ...
  if (listenOrientation) {
    ...
    ;(0, import_vue2.watch)(matches, () => update())
  }
  return { width, height }
}
...
//# sourceMappingURL=chunk-RNNB46ZJ.js.map

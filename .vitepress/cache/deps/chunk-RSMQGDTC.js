import { __commonJS, __esm, __export, __toCommonJS } from './chunk-V4OQ3NZ2.js'
  ...
  switch (node.type) {
    case 1:
      for (let i = 0; i < node.props.length; i++) {
        ...
        if (
          p2.type === 7 &&
          (hasScopeRef(p2.arg, ids) || hasScopeRef(p2.exp, ids))
        ) {
          return true
        }
      }
    ...
    if (p2.type === 6) {
      if (p2.name === 'is' && p2.value) {
        if (p2.value.content.startsWith('vue:')) {
          ...
          checkCompatEnabled('COMPILER_IS_ON_ELEMENT', currentOptions, p2.loc)
        ) {
          return true
        }
      }
...
Use a v-bind binding combined with a v-on listener that emits update:x event instead.`,
    ...
    buildClientSlotFn = (props, _vForExp, children, loc) =>
      createFunctionExpression(
        props,
        children,
        false,
...
var init_reactivity_esm_bundler = __esm({
  'node_modules/.pnpm/@vue+reactivity@3.5.13/node_modules/@vue/reactivity/dist/reactivity.esm-bundler.js'() {
    ...
    ITERATE_KEY = Symbol(true ? 'Object iterate' : '')
    MAP_KEY_ITERATE_KEY = Symbol(true ? 'Map keys iterate' : '')
    ARRAY_ITERATE_KEY = Symbol(true ? 'Array iterate' : '')
    arrayInstrumentations = {
      __proto__: null,
      [Symbol.iterator]() {
...
var init_runtime_dom_esm_bundler = __esm({
  'node_modules/.pnpm/@vue+runtime-dom@3.5.13/node_modules/@vue/runtime-dom/dist/runtime-dom.esm-bundler.js'() {
    ...
    Transition = decorate$1((props, { slots }) =>
...
vue/dist/vue.cjs.js:
  ...
  **)
*/
//# sourceMappingURL=chunk-RSMQGDTC.js.map

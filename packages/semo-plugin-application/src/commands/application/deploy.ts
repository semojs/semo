...
export const desc = 'Deploy command placeholder'
// export const aliases = ''
// export const middleware = (argv) => {}

export const builder = function (yargs: any) {
  // yargs.option('option', { default, describe, alias })
  // yargs.commandDir('deploy')
}

export const handler = async function (argv: any) {
  Utils.info(`You see this command because this is a placeholder command, will do nothing.`)
  Utils.info(`You can use ${Utils.chalk.green('semo generate command application/deploy --extend=application')} in your project to override this command.`)
